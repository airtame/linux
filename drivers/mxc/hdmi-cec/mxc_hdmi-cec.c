...
void mxc_hdmi_cec_handle(u16 cec_stat)
{
  ...
  pr_debug("%s(%d): cec_stat = %hu\n", __func__, __LINE__, cec_stat);
			    ...
			    loff_t *ppos)
{
  ...
  print_hex_dump(KERN_INFO, " ", DUMP_PREFIX_ADDRESS, 12, 1, event, sizeof(*event), false);
	vfree(event);
			     ...
			     size_t count, loff_t *ppos)
{
	...
	msg_len = count;
  print_hex_dump(KERN_INFO, " ", DUMP_PREFIX_ADDRESS, 12, 1, msg, msg_len, false);
